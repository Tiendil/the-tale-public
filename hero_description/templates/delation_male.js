...
pgf.descriptions.templates['delation-male'] = {
    name: "донос на мужчину",
    gender: "M",
    text: "   О преступнике злостном спешу сообщить вашему доблестному Ордену Серых Плащей. <br/> "
	    + "   Сей негодяй принадлежит к роду [[race]] и преступлений совершил множество, не боясь совсем, что внешность имеет приметную, кою укажу в конце письма своего, нагл зело и узнанным быть не опасается. <br/>"
        + "   О первом деянии его могу сообщить следующее: [[act]] <br/>"
		+ "   [[bonus1]] <br/>"
		+ "   Ещё известно достоверно, что он [[ritual]]. И это тоже подозрительно. <br/>"
		+ "   [[bonus2]] <br/>"
		+ "   [[bonus3]] <br/>"
		+ "   Имя своё, Герой, наглец не скрывает. А внешности оный следующей. <br/>"
    ...
    variables: {
        bonus1: { 1: {text: "[нет фразы]"},
		          2: {text: "Так же известно, что он регулярно грабит честных купцов и ворует письма, кои обещает доставить адресату за вознаграждение."},
                  3: {text: "Так же сообщаю, что он постоянно за кем-нибудь шпионит, а потом беда у тех возникает и проблемы многочисленные."}},
		bonus2: { 1: {text: "[нет фразы]"},
		          2: {text: "Совратил он ещё дочь нашего кузнеца и сбег, не женившись."},
		          3: {text: "Совратил он ещё дочь нашего кузнеца и сбег, не женившись. И жену кузнеца."},
		          4: {text: "Совратил он ещё дочь нашего кузнеца и сбег, не женившись. И жену кузнеца. А так же молодую жену старосты, за что и вовсе голову ему отрубить след."},
                  5: {text: "Совратил он ещё дочь нашего кузнеца и сбег, не женившись. И жену кузнеца. А так же молодую жену старосты, за что и вовсе голову ему отрубить след. А опосля и сам староста от него еле сбег!"}},
		bonus3: { 1: {text: "[нет фразы]"},
                  2: {text: "В городе на стенах надписи похабные пишет и власти порочащие. А в кабаках благородные лица бьёт и песни пошлые горланит."}},
		...
		hands: { 1: {text: "цветы с шипами"},
				 ...
				 11: {text: "девки в позах развратных, голые совсем"},
