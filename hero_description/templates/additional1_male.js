...
pgf.descriptions.templates['additional1_male'] = {
    ...
    text: "Этот мужчина [[race]] называет себя Героем. Роста он [[stature]], сложения [[constitution]]. <br/> "
        ...
        + "В дорогу Герой одевается [[style_of_dress]]. В мирной жизни он предпочитает [[costume]]. Но это редко можно увидеть, большую часть времени Герой с оружием в руках и в доспехах [[profession]].",
    variables: {
		...
		fan: { 1: {text: "в спальне юной дочери старосты деревни"},
               ...
               4: {text: "у некой молодой вдовы, потерявшей мужа при загадочных обстоятельствах"},
